...
set confhome=https://raw.githubusercontent.com/imagehubcc/reinstall/main
set confhome_cn=https://cnb.cool/imagehubcc/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/imagehubcc/reinstall/main
